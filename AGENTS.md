...
- Keep `skills/aip/` focused on AIP capabilities and the workspace file contract. Authoring tools are selected separately; do not bundle framework dependencies, manuals, or rendering implementations. Verify file requirements against the service before changing the contract.
