...
Original AIP plugin source, helper scripts, tests, and the `skills/aip/` and `skills/aip-dynamic-caption/` skills are provided under the [MIT License](LICENSE), except for the HyperFrames-derived skill described below. This package contains no bundled third-party authoring engine, animation runtime, or media library.
